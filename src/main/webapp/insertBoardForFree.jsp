...
<script type="text/javascript">
	...
	function examine() {
		...
		location.href="insertBoardForFreeAct.do?boardClass=0&boardTitle=" + boardTitle + "&boardContents=" + boardContents + "&usRn=" + uCode + "&userName=" + uName;
	}
	...
	function loadOn() {
		...
		if(insertBoardSF==null){}else if(insertBoardSF==0){
			...
			location.href='insertBoardForFreeAct.do';
